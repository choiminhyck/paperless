		        ...
		        <table>
					...
					<td> 
						...
						<tr>
							...
							<td> <!-- 비용, 3자리 마다 , 찍히기 -->
								<input type="text" name="cost" class="cost money" size="10">원 
							</td>
							<td><!-- 지출 수단 -->
							...
							<td><!-- 영수증번호 -->
								<input type="text" name="receipt_no" class="receipt_no" size="10">
							</td>
							<td><!-- 지출일 -->
								<input type="date" name="expense_date" class="expense_date">
							</td>
							<td><!-- 비고 -->
								<input type="text" name="note" class="note" size="15">
							</td>
							</tr>
							</table>
						</td>
