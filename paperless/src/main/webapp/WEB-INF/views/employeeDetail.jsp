   ...
   <body>
      <div class="container" style="width:800px">
         ...
         <form name="employeeUpForm">
            <table class="empInfoTable">
               <tr>
                     ...
                     <td rowspan="8" style="width:400px">
                        <img class="emp_img" alt="사원사진" src="/img/${requestScope.empDTO.emp_img}" style="width:70%">
                     </c:if>
                     
                     <c:if test="${requestScope.role == 'USER'}">
                     <td rowspan="8" style="width:400px">
                        <img class="emp_img" alt="사원사진" src="/img/${requestScope.employeeDTO.emp_img}" style="height:70%">
                     </c:if>
               ...
               <c:if test="${requestScope.role == 'USER'}">                           <!-- 추가함 -->
               <tr>
                  <th>새 비밀번호</th>
                  <td>
            ...
            <input type="hidden" name="pwd" class="pwd" value="${requestScope.empolyeeDTO.pwd}">   
            <c:if test="${requestScope.role == 'MANAGER'}">
